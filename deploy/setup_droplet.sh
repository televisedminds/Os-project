...
echo "  dashboard (from a laptop): ssh -L 8000:localhost:8000 <you>@<droplet-ip>  →  http://localhost:8000"
echo "  dashboard (from your phone, no SSH tunnel): bash deploy/setup_https_dashboard.sh"
